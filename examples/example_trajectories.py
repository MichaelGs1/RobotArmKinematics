...
def main():
    ...
    T_tool_0 = np.array([[ 0.42435823  ,0.45504466, -0.78285018 ,-0.60542826],
    ...
    ax.plot(position_lin[:, 0], position_lin[:, 1], position_lin[:, 2], label="Trajectoire")
    ...
    ax = create_graph(max_dim=0.5)
    ax.plot(position_cir[:, 0], position_cir[:, 1], position_cir[:, 2], label="Trajectoire")
